...
const SidebarContainer = styled.div`
  width: 220px; /* match layout grid sidebar width */
...
/**
 * Sidebar
 * Purpose: Render the side links bar with module navigation.
 * Inputs: None.
 * Outputs: Sidebar navigation for modules and sublinks.
 */
const Sidebar = () => {
  const modules = [
    {
